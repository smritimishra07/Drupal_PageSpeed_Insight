...
#     """
#     Parses the PageSpeed Insights report and displays IDs with savings > 0.
#     """
#     print("\nParsing report for metrics with savings > 0...\n")
    
#     # Access audits under Lighthouse
#     audits = data.get("lighthouseResult", {}).get("audits", {})
#     if not audits:
#         print("No audits found in the report.")
#         return

#     # Filter and display audits with savings > 0
#     for audit_id, audit in audits.items():
#         details = audit.get("details", {})
#         savings = details.get("overallSavingsMs", 0)  # Savings in milliseconds
#         if savings > 0:
#             print(f"ID: {audit_id}")
#             print(f"Title: {audit.get('title')}")
#             print(f"Description: {audit.get('description')}")
#             print(f"Savings: {savings} ms\n")
